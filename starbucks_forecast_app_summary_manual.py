...
if high_risk_count == 0:
    summary_text = """### 📌 Summary for Audit Committee
    ...
    summary_text = """### 📌 Summary for Audit Committee
    One high-risk quarter was flagged in 2023 where actual revenue materially exceeded forecasted values. The model, based on CPI and avg ticket, generally aligns well otherwise.
    ...
    summary_text = """### 📌 Summary for Audit Committee
    Multiple high-risk quarters were flagged in 2023. Forecasts based on CPI and avg ticket showed persistent misalignment with reported revenue.
