...
model = SARIMAX(endog_train, exog=exog_train, order=(2, 1, 2), seasonal_order=(1, 1, 1, 4))
...
if high_risk_count == 0:
    summary_text = (
        ...
        "No high-risk quarters were identified in 2023. The ARIMAX forecast using CPI and avg ticket closely aligns with reported revenue.\n\n"
        "This consistency suggests that Starbucks' reported revenue is well-supported by key economic and operational inputs. "
        "The regression model further confirms this by showing minimal variance between expected and actual revenues across all quarters. "
        "The observed alignment between revenue growth and input growth patterns strengthens the case for reliability in reported figures.\n\n"
    ...
    summary_text = (
        "### 📌 Summary for Audit Committee\n"
        "One high-risk quarter was flagged in 2023 where actual revenue materially exceeded forecasted values. "
        "The model, based on CPI and avg ticket, generally aligns well otherwise.\n\n"
        "The presence of a single significant deviation warrants targeted scrutiny. "
        "Auditors should consider whether temporary operational or macroeconomic anomalies might explain the gap. "
        "If no external justification is found, this deviation could indicate a timing or estimation error in revenue recognition.\n\n"
    ...
    summary_text = (
        "### 📌 Summary for Audit Committee\n"
        "Multiple high-risk quarters were flagged in 2023. "
        "Forecasts based on CPI and avg ticket showed persistent misalignment with reported revenue.\n\n"
        "Such repeated deviations raise substantial concern about potential overstatement of revenue. "
        "The regression model also reflects a breakdown in the relationship between operational drivers and reported figures, "
        "especially where revenue growth far exceeds changes in underlying inputs.\n\n"
        "Auditors should investigate these flagged quarters thoroughly, focusing on revenue recognition timing, estimates, and the validity of recorded results. "
        "Evidence of revenue recognition that outpaces business activity may warrant extended testing and disclosure consideration."
    )
